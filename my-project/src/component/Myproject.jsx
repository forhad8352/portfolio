      ...
      <section id="project">
        ...
        <div className=" lg:flex justify-between flex-wrap">
          <div className="mt-10 lg:mt-0 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500"  >
            <img src={Hec} alt="" className="w-full h-[200px]" />
            <h3 className="text-xl font-bold mb-2 font-caslon text-[#d6cece]" data-aos="fade-right">
              E-commerce Website
            </h3>
            <p className="font-caslon font-medium text-[#d6cece]" data-aos="fade-right">
              javascript/tailwind CSS/React
            </p>
            <a
              target="blank"
              href="https://ecommerce-jmpe.vercel.app"
              className="text-teal-400 mt-4 inline-block" data-aos="fade-right"
            >
              View Project
            </a>
          </div>
          ...
          <div className="mt-10 lg:mt-0 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500">
            <img src={Oreb} alt="" className="w-full h-[200px]" />
            <h3
          ...
          <div
            className="mt-10 lg:mt-0 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500">
            <img src={Big} alt="" className="w-full h-[200px]" />
            <h3 className="text-xl font-bold mb-2 font-caslon text-[#d6cece]"  data-aos="fade-right">
              Bootstrap Project
            </h3>
            <p className="font-caslon font-medium text-[#d6cece]" data-aos="fade-right">
            ...
            <a
              ...
              className="text-teal-400 mt-4 inline-block font-caslon" data-aos="fade-right"
            >
              View Project
            </a>
          </div>
          <div className="mt-10 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500" >
            <img src={Creativ} alt="" className="w-full h-[200px]" />
            <h3 className="text-xl font-bold mb-2 font-caslon text-[#d6cece]" data-aos="fade-right">
              Bootstrap Project
            </h3>
            <p className="font-caslon font-medium text-[#d6cece]" data-aos="fade-right">
          ...
          <div className="mt-10 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500" >
            <img src={Bwfc} alt="" className="w-full h-[200px]" />
            <h3 className="text-xl font-bold mb-2 font-caslon text-[#d6cece]" data-aos="fade-right">
              Javascript Project
            </h3>
            <p className="font-caslon font-medium text-[#d6cece]" data-aos="fade-right">
          ...
          <div
            className="mt-10 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500"  >
            <img src={Pet} alt="" className="w-full h-[200px]" />
            <h3 className="text-xl font-caslon font-bold mb-2 text-[#d6cece]" data-aos="fade-right">
              React Project
            </h3>
            <p className="font-caslon font-medium text-[#d6cece]" data-aos="fade-right">
              react/Tailwindcss
          ...
          <div
            className="mt-10 lg:w-[32%] p-4 border border-gray-700 rounded-lg hover:bg-gray-800 transition transform hover:-translate-y-8 duration-500">
            <img src={Mah} alt="" className="w-full h-[200px]" />
            <h3 className="text-xl font-caslon font-bold mb-2 text-[#d6cece]" data-aos="fade-right">
              Html Project
            </h3>
            <p className="font-caslon font-medium text-[#d6cece]" data-aos="fade-right">Html/CSS</p>
            <a
              target="blank"
